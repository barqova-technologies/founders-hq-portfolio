  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 30% 30%, rgba(0,0,0,0.06), transparent 50%), radial-gradient(circle at 70% 70%, rgba(0,0,0,0.05), transparent 50%)",
        }}
      />
      <div
        aria-hidden
